...
public class MyCustomFCMService extends FirebaseMessagingService {
...
//            LocalBroadcastManager localBroadcastManager = LocalBroadcastManager.getInstance(MyCustomFCMService.this);
//            localBroadcastManager.sendBroadcast(new Intent("com.close"));
//        }
//    }
//    private void sendNotification(String messageBody) {
//        Intent intent;
//        intent = new Intent(this, AcceptUserRequestActivity.class);
...
//    }
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        {
            SharedPreferences.Editor editor = getSharedPreferences("notification",0).edit();
